...
<nav>
        <ul>
            <li> <a href="tipos_cursos.php?curso=php">PHP </a></li>
            <li> <a href="tipos_cursos.php?curso=json">JSON</a></li>
            <li> <a href="tipos_cursos.php?curso=mysql">MySQL </a></li>
        </ul>
    </nav>
    <?php
    ...
    if(!isset($_GET['curso'])) {
        echo 'Selecciona el Curso';
    }
    else if ($_GET['curso']=='php'){
        $Nombrecurso = 'PHP';
        $Niveles = 'Principiante';
    }
    else if ($_GET['curso']=="json"){
        $Nombrecurso = 'JSON';
        $Niveles = 'Avanzado';
    }
    else if ($_GET['curso']=="mysql"){
        $Nombrecurso = 'MySQL';
        $Niveles = 'Intermedio';
    }
    else {
